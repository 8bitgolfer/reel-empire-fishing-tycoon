...
- Trips focus on dock evolution, fishing spots, and boats.
...
- The economy is intentionally slower: upgrade prices scale sharply, multiplier stacking is compressed, and late-game progression is meant to take much longer.
...
- Rods have rarities, and duplicate crate pulls refund half the crate price in gems.
- Crate keys can open crates without spending gems.
- The Captain's Hub adds scaling daily quests, rotating live events, scaling boat expeditions, and prestige.
...
- Upgrade: 18 crate-only rods with rarities, 14 expensive bait tiers, 14 catch-value Angler bonuses, 15 fishing spots, and 13 boats
...
- Long-term loop: chase crate keys, complete scaling daily quests, send scaling expeditions, collect high-value trophies, and prestige for permanent Pearls
