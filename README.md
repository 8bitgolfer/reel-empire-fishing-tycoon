...
A colorful, pixel-art automatic fishing game. Start on a tiny dock with a basic rod and bluegill, then grow into private lakes, deep-sea charters, legendary waters, and a complete rare-fish collection. A fish is caught automatically every three seconds while the game is open. The fishing-specific navigation includes Tycoon, Rods, Bait Shop, Anglers, Trips, Crates, Hub, and Fishdex.
...
- Stronger rods add their own gem-luck bonus on top of bait chance, and the strongest owned rod equips automatically.
- Rods have rarities, and duplicate crate pulls level up rods while refunding some gems so bad luck still moves the player forward.
- Crate keys can open crates without spending gems.
- The Captain's Hub adds daily quests, rotating live events, boat expeditions, a 5-minute tournament mode, random fishing-choice boosts, and prestige.
...
- Upgrade: 18 crate-only rods with rarities and levels, 14 bait tiers, 14 catch-value Angler bonuses, 15 fishing spots, and 13 boats
...
- Long-term loop: chase crate keys, level duplicate rods, win tournaments, complete daily quests, send expeditions, and prestige for permanent Pearls
